<template>
  <div
    class="flex items-center justify-between h-auto min-h-screen m-auto overflow-y-clip sm:justify-center sm:overflow-hidden"
  >
    <div class="relative w-full md:w-6/12 lg:w-5/12 xl:w-4/12">
      ...
      >
        ...
        <div class="relative flex justify-around mt-10 bottom-5 sm:mt-24">
          <div
            @click="toggleLanguage"
            class="relative flex items-center p-2 space-x-2 transition-colors duration-300 rounded-md cursor-pointer text-dark-300 dark:text-light dark:hover:text-golden"
          >
          ...
          <div
            ...
            class="relative flex items-center p-2 ml-5 space-x-2 transition-colors duration-300 rounded-md cursor-pointer animate-pulse text-dark-300 dark:text-light dark:hover:text-golden"
          >
            <NightIcon
              class="w-6 h-6 fill-dark-300 dark:fill-light"
              v-if="!getDarkModeStatus"
            />
            <LightIcon class="w-6 h-6 fill-dark-300 dark:fill-light" v-else />
    ...
    <div hidden class="h-screen clip md:w-6/12 lg:block lg:w-7/12 xl:w-8/12">
      <video
        playsinline
...
const language = ref(() => store.getters["global/getLanguage"]);
